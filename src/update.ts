...
export const OPENAI_CODEX_VERIFIED_COMPATIBILITY_URL = 'https://raw.githubusercontent.com/reinainblood/dsh-codex-connect/codex/dsh-desktop-2.0.4-alpha425/verified-compatibility.json'
