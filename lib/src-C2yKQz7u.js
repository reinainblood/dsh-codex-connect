...
const OPENAI_CODEX_VERIFIED_COMPATIBILITY_URL = "https://raw.githubusercontent.com/reinainblood/dsh-codex-connect/codex/dsh-desktop-2.0.4-alpha425/verified-compatibility.json";
...
const CODEX_CONNECT_VERSION = "0.1.0-alpha.4.25";
//#endregion
...
var OpenAICodexAutoReviewBackend = class {
	...
	async review(input) {
		...
		try {
			...
			const accountId = stored?.type === "oauth" && typeof stored.accountId === "string" ? stored.accountId : void 0;
