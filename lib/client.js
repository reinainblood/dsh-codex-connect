	...
	factory: (require) => {
		...
		*/
		...
		var OpenAICodexAccountStore = class {
			...
			schedule() {
				clearTimeout(this.timer);
				const interval = this.snapshot.status.status === "signing-in" ? 1e3 : this.snapshot.status.status === "signed-in" ? 6e4 : void 0;
			...
			async refresh() {
				...
				try {
					const status = await request(OPENAI_CODEX_AUTH_STATUS_PATH, "GET", controller.signal);
					if (!controller.signal.aborted) this.publish({
						status,
						busy: false,
						...status.status === "signing-in" && this.snapshot.loginUrl !== void 0 ? { loginUrl: this.snapshot.loginUrl } : {}
					});
				} catch (error) {
					if (!controller.signal.aborted) this.publish({
			...
			async signIn() {
				...
				try {
					const challenge = await request(OPENAI_CODEX_AUTH_LOGIN_PATH, "POST");
					if (this.disposed) {
						popup?.close();
						return;
					}
			...
			async cancel() {
				...
				try {
					const status = await request(OPENAI_CODEX_AUTH_CANCEL_PATH, "POST");
					this.publish({
						status,
						busy: false
					});
		...
		const OPENAI_CODEX_CONTEXT_LIMIT_SOURCE = "https://github.com/openai/codex/blob/7625343977154efed8c0dadba956374992a1580b/codex-rs/models-manager/models.json";
		Object.freeze({
			"gpt-5.6-sol": 872e3,
			"gpt-5.6-terra": 872e3,
			"gpt-5.6-luna": 872e3,
		...
		function AccountActions({ t, store, snapshot, compact = false }) {
			...
			if (status.status === "signed-in") return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
				type: "button",
				style: buttonStyle$1,
				disabled: busy,
				onClick: () => {
			...
			if (status.status === "signing-in") return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				style: rowStyle,
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
					type: "button",
					style: buttonStyle$1,
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							...
							children: [
								...
								/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
									...
									}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)(AccountActions, {
										t,
										store,
										snapshot
									})]
		...
		*/
		...
		const en = {
			...
			contextLimitSource: "Source: official Codex configuration catalog (2026-08-28)",
		...
		const zh = {
			...
			contextMaximum: "配置上限",
			contextLimitSource: "依据：Codex 官方配置目录（2026-08-28）",
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(AccountActions, {
									t,
									store: account,
									snapshot,
									compact: true
									...
									style: buttonStyle,
									children: t(expanded ? "hideQuota" : "viewQuota")
								})]
							})
						]
					}),
